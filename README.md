...
Add this id to the element that will display the number of players.

- `value`

Add this id to the element that will display the price.

- `cost`

### Currency buttons (generated by Webflow Collection List) ```html
