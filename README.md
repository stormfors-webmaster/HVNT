...
```html
<button id="monthly" class="is-active"><div>Monthly</div></button>
<button id="yearly"><div>Yearly</div></button>

<div id="monthly-price" class="price_wrap">
  <h3 id="monthly-price-text-original" class="price_text strike-through">
    €650
  </h3>
  <div class="no-wrap">
    <h3 id="monthly-price-text-offer" class="price_text">€435</h3>
    <h3 class="price_text"><span class="p2 text-weight-medium">/mo</span></h3>
  </div>
</div>

<div id="yearly-price" class="price_wrap" style="display: none;">
  <h3 id="yearly-price-text-original" class="price_text strike-through">
    €6,900
  </h3>
  <div class="no-wrap">
    <h3 id="yearly-price-text-offer" class="price_text">€4,623</h3>
    <h3 class="price_text"><span class="p2 text-weight-medium">/year</span></h3>
  </div>
</div>
```
